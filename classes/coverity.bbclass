...
COVERITY_BLACKLIST_PATH += "avro-c | graphite2 | zilker | wdmp-c | ctrlm-testapp | wpeframework | mkimage| openssl | kernel-module-mtk-ab-boot | kernel-module-mtk-vcu | mk-drivers | kernel-module-nvmem | kernel-module-mtk-cec | kernel-module-xcker | kernel-module-mwgifker | mtktv-modules | kernel-module-mtk-vcodec | kernel-module-misck | kernel-module-mik | mi-headers | mtk-tvconfig-image"
