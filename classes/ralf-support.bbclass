...
# creates a dedicated ralf user and group for the container in non-root mode
# to be used when starting RALF applications; actual permissions must be
# configured by the consuming recipes or images as needed.
